...
Route::prefix('admin')->name('admin.')->middleware(['auth','check_permissions'])->group(function(){
    ...
    Route::delete('/selected-post', [AdminPostsController::class, 'deleteAll'])->name('posts.deleteAll');
    Route::post('/poststitle', [AdminPostsController::class, 'to_slug'])->name('posts.to_slug');
    Route::resource('categories', AdminCategoriesController::class);
    Route::post('/categoriestitle', [AdminCategoriesController::class, 'to_slug'])->name('categories.to_slug');
    Route::delete('/selected-category', [AdminCategoriesController::class, 'deleteAll'])->name('categories.deleteAll');
    Route::delete('/selected-category-post', [AdminCategoriesController::class, 'deletePostCategory'])->name('categories.deletePostCategory');




    Route::resource('tags', AdminTagsController::class)->only(['index','show','destroy']);
    Route::delete('/selected-tag', [AdminTagsController::class, 'deleteAll'])->name('tags.deleteAll');
    Route::resource('comments', AdminCommentsController::class)->except('show');
    Route::delete('/selected-comment', [AdminCommentsController::class, 'deleteAll'])->name('comments.deleteAll');

    Route::resource('roles', AdminRolesController::class)->except('show');
    Route::delete('/selected-role', [AdminRolesController::class, 'deleteAll'])->name('roles.deleteAll');
    Route::resource('users', AdminUsersController::class);
    Route::delete('/selected-user', [AdminUsersController::class, 'deleteAll'])->name('users.deleteAll');
