...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('kcnew/frontend/img/image_iconLogo_removebg.png') }}"
        sizes="160x160">
...
<body class="boxed" data-bg-img="{{ asset('kcnew/frontend/img/bg_website.png') }}">
            ...
            <div class="container">
                ...
                <div class="float--right float--xs-none text-xs-center">
                            ...
                            <li class="has-dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    @if (auth()->user()->role->name !== 'user')
                                        <li>
                                            <a href="{{ route('admin.index') }}"><i class="fa fm fa-user-secret"></i>
                                                Quản trị</a>
                                        </li>
                                    @endif
                                    <li>
                                        <a href="{{ route('profile') }}"><i class="fa fm fa-user"></i> Tài khoản</a>
                                    </li>
                                    <li>
                                        <a onclick="event.preventDefault(); document.getElementById('nav-logout-form').submit();"
                                            href=""><i class="fa fm fa-sign-out"></i> Đăng xuất
                                        </a>
                    ...
                    <ul class="header--topbar-social nav hidden-sm hidden-xxs">
                        <li><a href="https://www.facebook.com/voquyduc" target="_blank"><i
                                    class="fa fa-facebook"></i></a></li>
                        <li><a href="https://www.facebook.com/voquyduc" target="_blank"><i
                                    class="fa fa-twitter"></i></a></li>
                        <li><a href="https://www.facebook.com/voquyduc" target="_blank"><i
                                    class="fa fa-google-plus"></i></a></li>
                        <li><a href="https://www.facebook.com/voquyduc" target="_blank"><i class="fa fa-rss"></i></a>
                        </li>
                        <li><a href="https://www.facebook.com/voquyduc" target="_blank"><i
                    ...
                    <ul class="header--menu-links nav navbar-nav" data-trigger="hoverIntent">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="{{ route('newPost') }}">Tin tức mới nhất</a></li>
                                <li><a href="{{ route('hotPost') }}">Tin nóng</a></li>
                                <li><a href="{{ route('viewPost') }}">Xem nhiều nhất</a></li>
    ...
    <footer id="colorlib-footer">
        ...
        <div class="container">
            <div style=" padding: 25px 0; display: flex;" class=" row">
                <div class="col-md-4">
                    <p class="text-center">
                        <a href="{{ route('home') }}">
                            <img style="border-radius: 12px; width: 160px;"
                                src="{{ asset('kcnew/frontend/img/image_logo-removebg.png') }}" alt="logo">
                        </a>
                    </p>
                    <p>
                    <ul style="display: flex;justify-content: center;"
                        class="header--topbar-social nav hidden-sm hidden-xxs">
                        <li><a href="https://www.facebook.com/voquyduc" target="_blank"><i
                                    class="fa fa-facebook"></i></a></li>
                        <li><a href="https://www.facebook.com/voquyduc" target="_blank"><i
                                    class="fa fa-twitter"></i></a></li>
                ...
                <div class="col-md-4">
                    <p>
                        <span style="font-size: 14px" class="block">Tổng biên tập: 24h News</span>
                    </p>
                    <p>
                        <span style="font-size: 14px" class="block">Địa chỉ: 137 Nguyễn Thị Thập, Phường Hoà Minh,
                            Quận Liên Chiểu, Đà Nẵng</span>
                    </p>
                    <p>
                        <span style="font-size: 14px" class="block">Điện thoại: 0332143234</span>
                    </p>
                    <p>
                        <small style="font-size: 14px" class="block">&copy; 2023. Toàn bộ bản quyền thuộc Võ Quý
                            Đức</small>
                    </p>
                </div>
                <div class="col-md-4 ">
                ...
                if (!isEmail(email)) {
                    ...
                    $.ajax({
                        ...
                        statusCode: {
                            500: () => {
                                $("body").append(
                                    "<div class='global-message alert alert-danger subscribe-error'>Email này đã subscribe website của chúng tôi</div>"
                                );
