...
@section('title', '24h News - Thông tin tài khoản')
@section('content')
    ...
    @auth
        ...
        <div class="main-content--section pbottom--30">
            <div class="container">
                <h3 class="page-header text-center">Thông tin cá nhân</h3>
                <div class="row">
                    <form action="{{ route('update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="text-center">
                                <img style="    border: 4px solid #979993; border-radius: 50%; margin: auto; background-size: cover ;  width: 180px; height: 180px;   background-image: url({{ auth()->user()->image ? asset('storage/' . auth()->user()->image->path) : asset('storage/placeholders/user_placeholder.jpg') }})"
                                    alt="">
                                <div class="mb-3">
                                    <label for="input_image" class="form-label">Ảnh đai diện</label>
                                    <input style="background-color: #ffffff; color: black;" name="image" type="file"
                                        class="form-control text-center center-block well well-sm" id="input_image">
                                    @error('image')
                                    ...
                                    <div class="col-lg-6">
                                        <div class="border border-3 p-4 rounded">
                                            ...
                                            <div style="margin-bottom: 30px;" class="mb-3">
                                                ...
                                                <input style="height: 36px" name="name" type="text" class="form-control"
                                                    id="input_name" value='{{ old('name', $user->name) }}'>
                ...
                {{-- <h3 class="page-header text-center">Đổi mật khẩu</h3>
                <div class="row">
                    <form action="{{ route('password.update') }}" method="post" enctype="multipart/form-data">
                        <div class="col-md-4 col-sm-6 col-xs-12">
                        </div>
                        <div class="col-md-7 col-sm-6 col-xs-12" style="margin-left: 32px;">
                            <div class="form-body mt-4">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="border border-3 p-4 rounded">
