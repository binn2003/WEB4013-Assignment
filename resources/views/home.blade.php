...
@section('title', '24h News - Trang Tin Tức Việt Nam')
                            ...
                            <div class="col-md-6">
                                <div class="row gutter--15">
                                    ...
                                    <div class="col-sm-12 hidden-sm hidden-xs">
                                        <!-- Post Item Start -->
                                        <div class="post--item post--layout-1 post--title-larger" style="margin-top: 37px;">
                                            <div class="post--img">
                                                                ...
                                                                <h3 class="h4">
                                                                    @if(!empty($post_category_home0[0]))
                                                                        <a
                                                                            ...
                                                                            class="btn-link">{{ $post_category_home0[0]->title }}
                                                                        </a>
                                                                    @endif
                                                                </h3>
                                                            </div>
                                ...
                                <div class="social--widget style--2">
                                    <ul class="nav row gutter--20">
                                        <li class="col-md-12 facebook">
                                            <a target="__blank" href="https://www.facebook.com/voquyduc">
                                                <span class="icon">
