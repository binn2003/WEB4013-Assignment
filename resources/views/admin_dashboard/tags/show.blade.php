            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Từ khoá "{{ $tag->name }}"</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="badge rounded-pill @if($post->approved === 1)  {{'text-success bg-light-success' }} @elseif($post->approved === 0) {{'text-danger bg-light-danger'}} @else {{'text-warning bg-light-warning' }} @endif p-2 text-uppercase px-3">
