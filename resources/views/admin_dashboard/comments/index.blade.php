                ...
                <div class="card-body">
                    <div class="container p-3 row justify-between">
                        <div class="row">
                            ...
                            <form action="{{ route('admin.comments.index') }}" class="col-md-8">
                                <div class="form-group row">

                                    <div class="col-md-9">
                                        <input type="text" class="form-control" value="{{ $search }}"
                                            name="search" placeholder="Tìm kiếm bình luận/người bình luận">
                                    </div>
                                    <div class="col-md-2">
                            ...
                            <div class="col-md-2"><a href="{{ route('admin.comments.create') }}"
                                    ...
                                    <tr id="comment_ids{{ $comment->id }}">
                                        <td>
                                            <input class="checkbox_ids form-check-input me-3" type="checkbox" name="ids" id=""
                                                value="{{ $comment->id }}" aria-label="...">
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="ms-2">
                                                    <h6 class="mb-0 font-14">ID-{{ $comment->id }}</h6>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex order-actions">
                                                ...
                                                <a href="#"
                                                    ...
                                                    data-id="{{ $comment->id }}" class="ms-3 btn-del"><i
                    ...
                    <div class="mt-4">
                        @if (!empty($comment))
                            <div style="text-align: right; margin-right: 3%">Tổng số {{ $comment->count() }} bình luận
                            </div>
                        @endif
                        {{ $comments->links() }}
                    </div>
