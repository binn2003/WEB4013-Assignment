...
<div class="sidebar-wrapper" data-simplebar="true">
    <div class="sidebar-header">
        <div>
            <img src="{{ asset('kcnew/frontend/img/image_logo-removebg.png') }}" class="logo-icon" alt="logo icon">
        </div>
        <div>
    ...
    <ul class="metismenu" id="menu">
        <li>
            <a target="_blank" href="{{ route('home') }}">
                ...
                <div class="menu-title">Xem Website</div>
            </a>
        </li>
        <hr>
            ...
            <li>
                ...
                <ul>
                    ...
                    @if (checkPermission('admin.roles.create'))
                        <li> <a href="{{ route('admin.roles.create') }}"><i class="bx bx-right-arrow-alt"></i>Thêm
                                quyền mới</a>
                        </li>
                    @endif
                </ul>
