                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="border border-3 p-4 rounded">
                                        ...
                                        <div class="mb-3">
                                            <label for="input_password" class="form-label">Cập nhật mật khẩu mới</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" name="image" type="file" class="" id="input_image">
                                            ...
                                            <div class="col-md-4">
                                                <div class="user_image">
                                                    <img class="img_admn--user img-avatar" width="220px" height="220px"
                                                        style="border-radius: 50%; margin: auto; background-size: cover ;  background-image: url({{ !empty($image_path->path) ? asset('storage/' . $image_path->path) : asset('storage/placeholders/user_placeholder.jpg') }})"
                                                        alt="">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="mb-3">
                                                <select name="role_id" required class="single-select">
                                                    @foreach ($roles as $key => $role)
                                                        <option {{ $user->role_id === $key ? 'selected' : '' }}
                                        ...
                                        <a class="btn btn-secondary" href="{{ route('admin.users.index') }}">Danh sách</a>
