                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="border border-3 p-4 rounded">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-7 text-center">
                                                    <img style="width: 100%; border-radius: 16px;"
                                                        src="/storage/{{ $post->image ? $post->image->path : 'placeholders/placeholder-image.jpg' }}"
                                        ...
                                        @if(in_array($role, config('contans.roleApprovedPost')))
                                            <div class="mb-3">
                                        ...
                                        {{-- <a class="btn btn-danger"
                                            ...
                                            href="#">Xóa bài viết</a> --}}
                                        <a class="btn btn-secondary" href="{{ route('admin.posts.index') }}">Xem danh
                                            sách</a>
                                    </div>
                                </div>
                            </div>
