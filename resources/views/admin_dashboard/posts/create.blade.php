								...
								<div class="col-lg-12">
									<div class="border border-3 p-4 rounded">
										...
										<div class="mb-3">
											...
											<input type="text" value=' {{ old("slug" ) }}' name="slug" required  class="slugPost form-control" id="inputProductTitle" placeholder="Liên kết">
										...
										<div class="mb-3">
											<label for="inputProductDescription" class="form-label">Hình ảnh bài viết</label><br>
											<input class="form-control" id="thumbnail" require name="thumbnail" type="file" id="file">
											@error('thumbnail')
												<p class="text-danger">{{ $message }}</p>
											@enderror
										...
										<a class="btn btn-secondary" href="{{ route('admin.posts.index') }}">Danh sách</a>
									</div>
								</div>
							</div>
						</div>
